...
//import { HausaMenuOptionsComponent } from './hausamenu-options';
...
@Component({
  selector: 'hausahome',
  templateUrl: 'hausahome.html'
})
export class HausaHomePage implements OnInit {
  ...
  page1: any = 'HausaPage1';
  page2: any = 'HausaPage3';
  page3: any = 'HausaPage2';
  page4: any = 'HausaPage4';
//  page5: any = 'HausaPage5';
  ...
  menuOptions(): void {
    const popover = this.popoverCtrl.create('HausaMenuOptionsComponent', {}, {
