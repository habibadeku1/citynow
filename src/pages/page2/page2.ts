...
export class Page2 implements OnInit {
  ...
  ngOnInit(): void {
    ...
    MeteorObservable.subscribe('chats').subscribe(() => {
          ...
          MeteorObservable.subscribe('uonline').subscribe(() => {
            MeteorObservable.autorun().subscribe(() => {        
            
                this.users = this.findUsersOnline() 
...
/**    
  ...
  **/    
    ...
    findUsersOnline() {
          ...
          return Users.find({ "status.online": true, 'profile.pcity': Meteor.user().profile.plang }, {}).map(users => {
            ...
            users.forEach(user => {
              ...
              user.profile.picture = Pictures.getPictureUrl(user.profile.pictureId, platform);
