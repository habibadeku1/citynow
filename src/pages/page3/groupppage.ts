...
//import { PageMenuOptionsComponent3 } from './menu-options';
...
export class GroupPostsPage implements OnInit { 
 ...
 //     console.log(this.citypostsBatchCounter, "batchcounter")
  ...
  grouppostentry(grppost, localNavCtrl: boolean = false): void {
        ...
        const modal = this.modalCtrl.create('GroupPostEntry', {grppost: grppost}); 
        modal.present();
  ...
  unfollowgp(gpid: string): void {
    ...
    menuOptions(grouppost, localNavCtrl: boolean = false): void { 
      const popover = this.popoverCtrl.create('PageMenuOptionsComponent3', {grouppost}, {
