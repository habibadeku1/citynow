...
//import { HausaPageMenuOptionsComponent } from './hausamenu-options';
...
@Component({
      ...
      selector: 'hausapostpage',
    
      templateUrl: 'hausapostpage.html'
    
    }) 

    
export class HausaPostPage implements OnInit {
