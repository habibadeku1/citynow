...
//import { HausaReportPost } from './hausareportpost';
...
@IonicPage()
@Component({
  selector: 'hausapagemenu-options',
  templateUrl: 'hausapagemenu-options.html'
})

export class HausaPageMenuOptionsComponent implements OnInit {
  ...
  reportPost(cityid, localNavCtrl: boolean = false): void { 
    ...
    console.log(cityid)
    const popover = this.popoverCtrl.create('HausaReportPost', {cityid}, {
    });
