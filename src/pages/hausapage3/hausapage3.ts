...
@Component({
  selector: 'hausapage3',
  templateUrl: 'hausapage3.html'
})
export class HausaPage3 implements OnInit {
  ...
  showGroupPosts(group, localNavCtrl: boolean = false): void {
    ...
    if (localNavCtrl) {
      this.navCtrl.push('HausaGroupPostsPage', { group });
    } else {
      this.rootNavCtrl.push('HausaGroupPostsPage', { group });
    }
