...
@Component({
  selector: "hausapage3reportpost",
  templateUrl: "hausapage3reportpost.html" 


})
export class HausaReportPost3 implements OnInit {
...
**/
  ...
  //  }
    ...
    if(!this.eForm1.valid){
     ...
     MeteorObservable.call('reportPost',this.profile.pcity,this.eForm1.get(['updescr']).value, this.profile.fname, this.profile.sname, this.profile.picture, this.profile.pictureId, this.selectedCity ).subscribe({
