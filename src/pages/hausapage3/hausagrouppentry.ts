...
import { Profile,GroupPost } from 'api/models';
...
@IonicPage()
@Component({
  selector: "hausagrouppentry",
  templateUrl: "hausagrouppentry.html" 


})
export class HausaGroupPostEntry implements OnInit {
 ...
 // @ViewChild('eSlider') eSlider: any;
  ...
  constructor(public modalCtrl: ModalController, public toastCtrl: ToastController, public loadingCtrl: LoadingController, public navCtrl: NavController, private alertCtrl: AlertController,
...
) 
  {
    ...
    this.selectedGroupid = navParams.get('grppost');

    console.log(navParams.get('grppost'));
