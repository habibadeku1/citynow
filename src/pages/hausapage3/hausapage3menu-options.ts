...
//import { HausaReportPost3 } from './hausareportpost'; 
...
@IonicPage()
@Component({
  selector: 'hausapage3menu-options',
  templateUrl: 'hausapage3menu-options.html'
})

export class HausaPageMenuOptionsComponent3 implements OnInit {
  ...
  reportPost(cityid, localNavCtrl: boolean = false): void { 
    ...
    console.log(cityid)
    const popover = this.popoverCtrl.create('HausaReportPost3', {cityid}, {
    });
